                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <span class="invalid-feedback"><?php echo $data['course_duration_err']; ?></span>
                                                                </div>
                                                                <div class="form-group">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <span class="invalid-feedback"><?php echo $data['course_price_err']; ?></span>
                                                                </div>
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <span class="invalid-feedback"><?php echo $data['instructor_err']; ?></span>
                                                                </div>
