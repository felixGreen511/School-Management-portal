                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                <form id="add-department" action="<?php echo URLROOT; ?>/departments/addDepartment" method="POST" class="add-department">
                                                    <div class="row">
                                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                            <div class="form-group">
                                                                ...
                                                                <span class="invalid-feedback"><?php echo $data['department_name_err']; ?></span>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <span class="invalid-feedback"><?php echo $data['department_head_err']; ?></span>
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <span class="invalid-feedback"><?php echo $data['number_students_err']; ?></span>
