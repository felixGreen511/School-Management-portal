            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="analytics-sparkle-line reso-mg-b-30">
                            <div class="analytics-content">
                                <h5> <a href="<?php echo URLROOT; ?>/instructors">Coding Instructors</a> </h5>
                                <h2><span class="counter"><?php echo $data['instructorRows']; ?></span> <span class="tuition-fees">Active Instructors</span>
                                </h2>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="analytics-sparkle-line reso-mg-b-30">
                            <div class="analytics-content">
                                <h5><a href="<?php echo URLROOT; ?>/students">Students</a> </h5>
                                <h2><span class="counter"><?php echo $data['studentRows'];?></span> <span class="tuition-fees">Trained Students</span>
                                </h2>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="analytics-sparkle-line reso-mg-b-30 table-mg-t-pro dk-res-t-pro-30">
                            <div class="analytics-content">
                                <h5><a href="<?php echo URLROOT; ?>/courses">Programming Courses</a> </h5>
                                <h2><span class="counter"><?php echo $data['courseRows'];?></span> <span class="tuition-fees">Available Coding Courses</span>
                                </h2>
                                <span class="text-info">85%</span>
                                <div class="progress m-b-0">
                                    <div class="progress-bar progress-bar-info" role="progressbar" aria-valuenow="50"
                                        aria-valuemin="0" aria-valuemax="100" style="width:85%;"> <span
                                            class="sr-only">20% Complete</span> </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="analytics-sparkle-line table-mg-t-pro dk-res-t-pro-30">
                            <div class="analytics-content">
                                <h5><a href="<?php echo URLROOT; ?>/ebooks">Libraries</a> </h5>
                                <h2><span class="counter"><?php echo $data['ebookRows']; ?></span> <span class="tuition-fees">Coding E-Books</span>
                                </h2>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <div class="caption pro-sl-hd">
                                            <span class="caption-subject"><b>CraftStack Earnings By Course</b></span>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        <div class="single-cards-item">
                            <div class="single-product-image">
                                <a href="#"><img src="<?php echo URLROOT; ?>/img/product/profile-bg.jpg" alt=""></a>
                            </div>
                            <div class="single-product-text">
                                <img src="<?php echo URLROOT; ?>/img/product/pro4.jpg" alt="">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        <div class="single-review-st-item res-mg-t-30 table-mg-t-pro-n">
                            ...
                            <div class="single-review-st-text">
                                <img src="<?php echo URLROOT; ?>/img/notification/1.jpg" alt="">
                            ...
                            <div class="single-review-st-text">
                                <img src="<?php echo URLROOT; ?>/img/notification/2.jpg" alt="">
                                <div class="review-ctn-hf">
                                    <h3>Garbease sha</h3>
                                    <p>Awesome Pro</p>
                                </div>
                            ...
                            <div class="single-review-st-text">
                                <img src="<?php echo URLROOT; ?>/img/notification/3.jpg" alt="">
                                <div class="review-ctn-hf">
                                    <h3>Gobetro pro</h3>
                                    <p>Great Website</p>
                                </div>
                            ...
                            <div class="single-review-st-text">
                                <img src="<?php echo URLROOT; ?>/img/notification/4.jpg" alt="">
                                <div class="review-ctn-hf">
                                    <h3>Siam Graves</h3>
                                    <p>That's Good</p>
                                </div>
                            ...
                            <div class="single-review-st-text">
                                <img src="<?php echo URLROOT; ?>/img/notification/5.jpg" alt="">
                                <div class="review-ctn-hf">
                                    <h3>Sarah Graves</h3>
                                    <p>Highly recommend</p>
                                </div>
                            ...
                            <div class="single-review-st-text">
                                <img src="<?php echo URLROOT; ?>/img/notification/6.jpg" alt="">
                                <div class="review-ctn-hf">
                                    <h3>Julsha Grav</h3>
                                    <p>Sei Hoise bro</p>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="single-product-item res-mg-t-30 table-mg-t-pro-n tb-sm-res-d-n dk-res-t-d-n">
                            <div class="single-product-image">
                                <a href="#"><img src="<?php echo URLROOT; ?>/img/product/book-4.jpg" alt=""></a>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="courses-inner res-mg-t-30 table-mg-t-pro-n tb-sm-res-d-n dk-res-t-d-n">
                            <div class="courses-title">
                                <a href="#"><img src="<?php echo URLROOT; ?>/img/courses/1.jpg" alt="" /></a>
